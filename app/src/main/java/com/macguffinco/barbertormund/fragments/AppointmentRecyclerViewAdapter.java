...
import com.macguffinco.barbertormund.fragments.AppointmentFragment.OnListFragmentInteractionListener;
import com.macguffinco.barbertormund.fragments.dummy.DummyContent.DummyItem;
...
public class AppointmentRecyclerViewAdapter extends RecyclerView.Adapter<AppointmentRecyclerViewAdapter.ViewHolder> {
    ...
    public AppointmentRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
